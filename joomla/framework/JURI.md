...
public static  <a href="../../joomla/framework/juri.html">JURI</a> **getInstance** (string uri)<div class="details">
...
public static  string **base** (boolean pathonly)<div class="details">
...
public static  string **root** (boolean pathonly, mixed path)<div class="details">
...
public  string **current** ()<div class="details">
...
public static  boolean **parse** (string uri)<div class="details">
...
public  string **toString** (array parts)<div class="details">
...
public  string **setprivate** (string name, string value)<div class="details">
...
public  array **getprivate** (string name, mixed default)<div class="details">
...
public  void **delprivate** (string name)<div class="details">
...
public  void **setQuery** (mixed (array|string), mixed query)<div class="details">
...
public  string **getQuery** (bool toArray)<div class="details">
...
public  string **buildQuery** (mixed params, mixed akey)<div class="details">
...
public  string **getScheme** ()<div class="details">
...
public  void **setScheme** (string scheme)<div class="details">
...
public  string **getUser** ()<div class="details">
<p>Get URI username
...
public  void **setUser** (string user)<div class="details">
...
public  string **getPass** ()<div class="details">
<p>Get URI password
...
public  void **setPass** (string pass)<div class="details">
...
public  string **getHost** ()<div class="details">
<p>Get URI host
...
public  void **setHost** (string host)<div class="details">
<p>Set URI host</p><dl>
<dt>Parameters:</dt>
...
public  int **getPort** ()<div class="details">
<p>Get URI port
...
public  void **setPort** (int port)<div class="details">
<p>Set URI port</p><dl>
<dt>Parameters:</dt>
...
public  string **getPath** ()<div class="details">
...
public  void **setPath** (string path)<div class="details">
...
public  string **getFragment** ()<div class="details">
...
public  void **setFragment** (string anchor)<div class="details">
...
public  boolean **isSSL** ()<div class="details">
