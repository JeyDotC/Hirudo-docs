...
**Smarty\Smarty_Internal_Compile_Setfilterclose**
<a href="https://github.com/JeyDotC/Hirudo-docs/blob/master/source/framework/libs/smarty/sysplugins/smarty_internal_compile_setfilter.php.md#line45" class="location">framework\libs\smarty\sysplugins\smarty_internal_compile_setfilter.php at line 45</a>
...
<p class="signature">public  class **Smarty_Internal_Compile_Setfilterclose**\nextends <a href="https://github.com/JeyDotC/Hirudo-docs/blob/master/smarty/smarty_internal_compilebase.html">Smarty_Internal_CompileBase</a>

</p>

<div class="comment" id="overview_description"><p>Smarty Internal Plugin Compile Setfilterclose Class</p></div>
...
<td class="description"><p class="name"><a href="#compile()">compile</a>(array args, object compiler)</p><p class="description">Compiles code for the {/setfilter} tagThis tag does not generate compiled output. </p></td>
</tr>
</table>
...
<a href="https://github.com/JeyDotC/Hirudo-docs/blob/master/source/framework/libs/smarty/sysplugins/smarty_internal_compile_setfilter.php.md#line56" class="location">framework\libs\smarty\sysplugins\smarty_internal_compile_setfilter.php at line 56</a>

<h3 id="compile()">compile</h3>
```php
public  string **compile**(array args, object compiler)```
<div class="details">
<p>Compiles code for the {/setfilter} tag</p><p>This tag does not generate compiled output. It resets variable filter.</p><dl>
<dt>Parameters:</dt>
