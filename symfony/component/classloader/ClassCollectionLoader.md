...
public static  void **load** (array classes, string cacheDir, string name, Boolean autoReload, Boolean adaptive, string extension)<div class="details">
...
public static  string **fixNamespaceDeclarations** (string source)<div class="details">
